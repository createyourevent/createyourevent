...
class AddressResourceIT {
    ...
    public static Address createEntity(EntityManager em) {
        Address address = new Address().address(DEFAULT_ADDRESS).lat(DEFAULT_LAT).lng(DEFAULT_LNG);
        return address;
    }
    ...
    public static Address createUpdatedEntity(EntityManager em) {
        Address address = new Address().address(UPDATED_ADDRESS).lat(UPDATED_LAT).lng(UPDATED_LNG);
        return address;
    }
    ...
    void putNewAddress() throws Exception {
        ...
        updatedAddress.address(UPDATED_ADDRESS).lat(UPDATED_LAT).lng(UPDATED_LNG);
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.lat(UPDATED_LAT).lng(UPDATED_LNG);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.address(UPDATED_ADDRESS).lat(UPDATED_LAT).lng(UPDATED_LNG);
