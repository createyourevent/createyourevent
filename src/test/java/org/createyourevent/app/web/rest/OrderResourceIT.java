...
import org.createyourevent.app.domain.Order;
import org.createyourevent.app.domain.enumeration.OrderStatus;
import org.createyourevent.app.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().status(DEFAULT_STATUS).dateAdded(DEFAULT_DATE_ADDED);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().status(UPDATED_STATUS).dateAdded(UPDATED_DATE_ADDED);
        return order;
    }
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.status(UPDATED_STATUS).dateAdded(UPDATED_DATE_ADDED);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.status(UPDATED_STATUS).dateAdded(UPDATED_DATE_ADDED);
