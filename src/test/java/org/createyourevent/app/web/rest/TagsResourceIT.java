...
class TagsResourceIT {
    ...
    public static Tags createEntity(EntityManager em) {
        Tags tags = new Tags().tag(DEFAULT_TAG);
        return tags;
    }
    ...
    public static Tags createUpdatedEntity(EntityManager em) {
        Tags tags = new Tags().tag(UPDATED_TAG);
        return tags;
    }
    ...
    void createTags() throws Exception {
        ...
        restTagsMockMvc
            .perform(
                post(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tags))
            )
    ...
    void putWithMissingIdPathParamTags() throws Exception {
        ...
        restTagsMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(tags))
            )
    ...
    void fullUpdateTagsWithPatch() throws Exception {
        ...
        partialUpdatedTags.tag(UPDATED_TAG);
