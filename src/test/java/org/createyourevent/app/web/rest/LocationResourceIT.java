...
class LocationResourceIT {
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getPhoto()).isEqualTo(DEFAULT_PHOTO);
        assertThat(testLocation.getPhotoContentType()).isEqualTo(DEFAULT_PHOTO_CONTENT_TYPE);
    }
    ...
    void putNewLocation() throws Exception {
        ...
        assertThat(testLocation.getPhoto()).isEqualTo(UPDATED_PHOTO);
        assertThat(testLocation.getPhotoContentType()).isEqualTo(UPDATED_PHOTO_CONTENT_TYPE);
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.name(UPDATED_NAME).photo(UPDATED_PHOTO).photoContentType(UPDATED_PHOTO_CONTENT_TYPE);
