...
class CartResourceIT {
    ...
    private static final Float DEFAULT_TOTAL_COSTS = 1F;
    private static final Float UPDATED_TOTAL_COSTS = 2F;
    ...
    public static Cart createEntity(EntityManager em) {
        Cart cart = new Cart().date(DEFAULT_DATE).totalCosts(DEFAULT_TOTAL_COSTS);
        return cart;
    }
    ...
    public static Cart createUpdatedEntity(EntityManager em) {
        Cart cart = new Cart().date(UPDATED_DATE).totalCosts(UPDATED_TOTAL_COSTS);
        return cart;
    }
    ...
    void createCart() throws Exception {
        ...
        assertThat(testCart.getTotalCosts()).isEqualTo(DEFAULT_TOTAL_COSTS);
    }
    ...
    void getAllCarts() throws Exception {
        ...
        restCartMockMvc
            ...
            .andExpect(jsonPath("$.[*].totalCosts").value(hasItem(DEFAULT_TOTAL_COSTS.doubleValue())));
    }
    ...
    void getCart() throws Exception {
        ...
        restCartMockMvc
            ...
            .andExpect(jsonPath("$.totalCosts").value(DEFAULT_TOTAL_COSTS.doubleValue()));
    }
    ...
    void putNewCart() throws Exception {
        ...
        updatedCart.date(UPDATED_DATE).totalCosts(UPDATED_TOTAL_COSTS);
        ...
        assertThat(testCart.getTotalCosts()).isEqualTo(UPDATED_TOTAL_COSTS);
    }
    ...
    void fullUpdateCartWithPatch() throws Exception {
        ...
        partialUpdatedCart.date(UPDATED_DATE).totalCosts(UPDATED_TOTAL_COSTS);
