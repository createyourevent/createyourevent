...
class ContactResourceIT {
    ...
    public static Contact createEntity(EntityManager em) {
        Contact contact = new Contact().name(DEFAULT_NAME).email(DEFAULT_EMAIL).message(DEFAULT_MESSAGE).date(DEFAULT_DATE);
        return contact;
    }
    ...
    public static Contact createUpdatedEntity(EntityManager em) {
        Contact contact = new Contact().name(UPDATED_NAME).email(UPDATED_EMAIL).message(UPDATED_MESSAGE).date(UPDATED_DATE);
        return contact;
    }
    ...
    void putNewContact() throws Exception {
        ...
        updatedContact.name(UPDATED_NAME).email(UPDATED_EMAIL).message(UPDATED_MESSAGE).date(UPDATED_DATE);
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.name(UPDATED_NAME).message(UPDATED_MESSAGE).date(UPDATED_DATE);
    ...
    void fullUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.name(UPDATED_NAME).email(UPDATED_EMAIL).message(UPDATED_MESSAGE).date(UPDATED_DATE);
