...
/**
 * REST controller for managing {@link org.createyourevent.app.domain.Worksheet}.
 */
@RestController
@RequestMapping("/api")
public class WorksheetResource {
    ...
    public ResponseEntity<List<Worksheet>> getAllWorksheets(Pageable pageable) {
        log.debug("REST request to get a page of Worksheets");
        Page<Worksheet> page = worksheetService.findAll(pageable);
