...
/**
 * REST controller for managing {@link org.createyourevent.app.domain.UserPointAssociation}.
 */
@RestController
@RequestMapping("/api")
public class UserPointAssociationResource {
    ...
    public ResponseEntity<List<UserPointAssociation>> getAllUserPointAssociations(Pageable pageable) {
        log.debug("REST request to get a page of UserPointAssociations");
        Page<UserPointAssociation> page = userPointAssociationService.findAll(pageable);
