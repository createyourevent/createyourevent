...
/**
 * REST controller for managing {@link org.createyourevent.app.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    public ResponseEntity<List<Location>> getAllLocations(Pageable pageable, @RequestParam(required = false) String filter) {
        if ("event-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(locationService.findAllWhereEventIsNull(), HttpStatus.OK);
        }
