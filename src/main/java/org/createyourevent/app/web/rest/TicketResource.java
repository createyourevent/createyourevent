...
public class TicketResource {
    ...
    public ResponseEntity<List<Ticket>> getAllTickets(Pageable pageable, @RequestParam(required = false) String filter) {
        if ("reservation-is-null".equals(filter)) {
            log.debug("REST request to get all Tickets where reservation is null");
            return new ResponseEntity<>(ticketService.findAllWhereReservationIsNull(), HttpStatus.OK);
        }
