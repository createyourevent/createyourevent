 ...
 * <p>
 * This class accesses the {@link org.createyourevent.app.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
@RestController
@RequestMapping("/api")
public class UserCreateYourEventResource {

    private final Logger log = LoggerFactory.getLogger(UserCreateYourEventResource.class);
    ...
    public UserCreateYourEventResource(UserService userService) {
     ...
     */
    @GetMapping("/users_createyourevent/{login}/findByLogin")
