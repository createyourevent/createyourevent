...
import { FeeBalanceComponent } from './fee-balance.component';

describe('FeeBalance Management Component', () => {
  let comp: FeeBalanceComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FeeBalanceComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.feeBalances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
