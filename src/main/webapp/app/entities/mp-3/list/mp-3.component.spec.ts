...
import { Mp3Component } from './mp-3.component';

describe('Mp3 Management Component', () => {
  let comp: Mp3Component;
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.mp3s?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
