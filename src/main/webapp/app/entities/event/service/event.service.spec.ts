...
describe('Event Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      price: 0,
      flyerContentType: 'image/png',
      flyer: 'AAAAAAA',
      youtube: 'AAAAAAA',
      privateOrPublic: 'AAAAAAA',
      active: false,
      minPlacenumber: 0,
      placenumber: 0,
      investment: 0,
  ...
  describe('Service methods', () => {
      ...
      const returnedFromService = Object.assign(
        {
          ...
          billed: true,
          stars: 1,
          billedOrganisator: true,
          billedeCreateYourEvent: true,
        },
        elemDefault
      );
    ...
    describe('addEventToCollectionIfMissing', () => {
      ...
      it('should add only unique Event to an array', () => {
        const eventArray: IEvent[] = [{ id: 123 }, { id: 456 }, { id: 85598 }];
