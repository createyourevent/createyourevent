...
describe('EventComment Management Component', () => {
  let comp: EventCommentComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EventCommentComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.eventComments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
