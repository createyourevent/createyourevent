...
describe('FeeTransaction Management Component', () => {
  let comp: FeeTransactionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FeeTransactionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.feeTransactions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
