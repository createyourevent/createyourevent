...
describe('ProductStarRating Management Component', () => {
  let comp: ProductStarRatingComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ProductStarRatingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productStarRatings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
