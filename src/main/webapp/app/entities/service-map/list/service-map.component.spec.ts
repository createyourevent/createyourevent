...
describe('ServiceMap Management Component', () => {
  let comp: ServiceMapComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ServiceMapComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.serviceMaps?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
