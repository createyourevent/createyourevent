...
export class ServiceMapComponent implements OnInit {
  ...
  trackId(index: number, item: IServiceMap): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IServiceMap[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
