...
describe('FeeTransactionEntry Management Component', () => {
  let comp: FeeTransactionEntryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FeeTransactionEntryComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.feeTransactionEntries?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
